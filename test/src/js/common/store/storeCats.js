            ...
            '<li>',
                ...
                '<div class="category">',
                    '{{each sub_cat_list as data i}}',
                        '<a href="../store/storeItems.html?cat_id={{data.cid}}&type={{cid | zyz}}" class="category_list">',
                            '{{data.cat_name}}',
                        '</a>',
                    '{{/each}}',
                '</div>',
            ...
            '<li>',  
                ...
                '<div class="category">',
                    '{{each brand_list as data i}}',
                        '<a href="../store/storeItems.html?cat_id={{cid}}&brand_id={{data.brand_id}}&type={{cid | zyz}}" class="category_img">',
...
Sort.prototype.event=function(){
    ...
    $('.search_bar').on('click','.search',function(){
        location.href='../store/storeItems.html?keyword=';
    });
};
